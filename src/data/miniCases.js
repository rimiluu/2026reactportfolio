...
export const miniCases = {
  ...
  cospre2024: {
    ...
    finalText: {
      ...
      mobileParagraphs: [
        "1ヶ月で9着を作る中で、布やパーツ不足、採寸ミスなど、予想外のことが何度も起きました。計画通りに進まない中で、作りながら判断する力がつきました。",
        "着る人の動きやすさを考え、マジックテープや縫い目の位置も調整しました。次回は、準備期間と制作数のバランスを見直したいです。",
      ],
    },
  },
  miso: {
    ...
    sections: [
      {
        ...
        mobileParagraphs: [
          "着物地の柄や質感を活かしながら、日常でも持ちやすいカジュアルなバッグにしました。カラフルな尾州の布を合わせ、軽やかで遊び心のある見え方を目指しています。",
        ],
      },
      {
        reverse: true,
        ...
        mobileParagraphs: [
          "神山町で譲っていただいた着物地を、若い世代にも届く形にしたいと考えました。着物らしさを残しすぎず、普段の服装に合わせやすいカジュアルさを意識しています。",
        ],
      },
    ],
    finalText: {
      heading: "ものづくりの原点と若い感性",
      paragraphs: [
      ...
      mobileParagraphs: [
        "着物や洋裁への興味は、着付けもものづくりもこなす祖母の影響から始まりました。身近な人の手仕事が、自分の制作の原点になっています。",
        "「みそ」では、素材の記憶を残しながら、若い世代が手に取りたくなる見え方を探しました。",
      ],
    },
  },
};
